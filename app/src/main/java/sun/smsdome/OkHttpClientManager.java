...
public class OkHttpClientManager {
     ...
     * @param callback
     */
    private void _getAsyn(String url, String head, String headbody,
     ...
     * @param params
     */
    private void _postAsyn(String url
            , final ResultCallback callback,
    ...
    // * @throws IOException
    // */
    // private void _displayImage(final ImageView view, final String url, final
    // int errorResId)
    // {
    ...
    public static void getAsyn(String url, String head, String headbody,
                               ResultCallback callback) {
        getInstance()._getAsyn(url, head, headbody, callback);
    }
...
//        testmap.putAll(params);
//        testmap.put("secret_key", HttpUtil.secret_key);
//        testmap.put("method", method);
//        for (Map.Entry<String, String> entry : testmap.entrySet()) {
//            sign = sign + entry.getKey() + "=" + entry.getValue() + "&";
//        }
//        params.put("sign", CursomUtils.stringToMD5(sign.substring(0, sign.length() - 1)));
